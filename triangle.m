...
w0 = [.5;5;1];  % initial angular velocity in the body frame
...
tracePts = [1, 2];  % which points to track
traceColors = ['g', 'c'];
...
obj = plot3(0,0,0, '-w', 'LineWidth',2); pens = plot3(0,0,0,'.', 'color', [1 0 0], 'MarkerSize',20);
